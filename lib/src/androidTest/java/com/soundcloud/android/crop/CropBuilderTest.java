...
public class CropBuilderTest extends BaseTestCase {
    ...
    public void testAspectRatioSetAsExtras() {
        ...
        assertThat(intent.getIntExtra("aspect_x", 200)).isEqualTo(16);
        assertThat(intent.getIntExtra("aspect_y", 200)).isEqualTo(10);
    }
    ...
    public void testFixedAspectRatioSetAsExtras() {
        ...
        assertThat(intent.getIntExtra("aspect_x", 200)).isEqualTo(1);
        assertThat(intent.getIntExtra("aspect_y", 200)).isEqualTo(1);
    }

    public void testMaxSizeSetAsExtras() {
        builder.withMaxSize(300, 300);

        Intent intent = builder.getIntent(activity);

        assertThat(intent.getIntExtra("max_x", 0)).isEqualTo(300);
    ...
    public void testBuildsIntentWithMultipleOptions() {
        ...
        assertThat(intent.getIntExtra("aspect_x", 200)).isEqualTo(1);
        assertThat(intent.getIntExtra("aspect_y", 200)).isEqualTo(1);
        assertThat(intent.getIntExtra("max_x", 200)).isEqualTo(200);
        assertThat(intent.getIntExtra("max_y", 200)).isEqualTo(200);
    }
