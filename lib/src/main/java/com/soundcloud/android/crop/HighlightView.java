...
class HighlightView {
    ...
    public static final int GROW_LEFT_EDGE   = (1 << 1); //触摸到左边界状态
    public static final int GROW_RIGHT_EDGE  = (1 << 2); //触摸到有边界状态
    public static final int GROW_TOP_EDGE    = (1 << 3); //触摸到上边界状态
    public static final int GROW_BOTTOM_EDGE = (1 << 4); //触摸到下边界状态
    ...
    // Determines which edges are hit by touching at (x, y) 通过x，y判断是否有碰触到HighlightView
